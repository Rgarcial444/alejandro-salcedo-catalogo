    ...
    <HeroHighlight containerClassName="min-h-screen pt-24 pb-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative h-[500px] lg:h-[560px] hidden md:block">
          ...
          >
            <img src={heroImages[0]} alt="Mazda CX-5 premium" className="h-full w-full object-cover" />
          </motion.div>
          <motion.div
          ...
          >
            <img src={heroImages[1]} alt="BMW Serie 3" className="h-full w-full object-cover" />
          </motion.div>
          <motion.div
